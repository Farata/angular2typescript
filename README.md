...
Besides the original code samples (they work with Angular 2) we created an Angular 4 versions of most code samples (these projects were generated by Angular CLI). 
